...
while opc != "34":
    ...
    if opc == "3":  
        ...
        os.system("cls")
        print("<---Curso--->")
        curso1 = Curso("Matemática", 5, "Ingeniería Software")
        print(curso1)
        curso1.mostrarDatos()
        input("Presione una tecla para continuar...")    
    elif opc == "29":
        ...
        os.system("cls")
        print("<---Cuenta--->")
        cuenta1 = Cuenta("Byron Llanos", 1500, "Dolares")
        ...
        os.system("cls")
        print("<---Herencia--->")
        estu1 = Estudiante("Torres", "López", "Juan", "Ingeniería Software")
        ...
        pais1 = Pais("Ecuador", "Byron Briones")
        print(pais1)

        ciudad1 = Ciudad("Milagro", 1500, pais1)
        print(ciudad1)
